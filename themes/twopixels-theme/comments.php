<div class="comments-area">
  ...
  if ( comments_open() ) : 
    ...
    <?php
    $fields = [
      'author' => '<div class="form-group mb-6 row justify-content-between text-primary fw-bold"><div class="col-6"><label class="mb-4" for="author">' . __( 'Ime i Prezime', 'domainreference' ) . '</label> <span class="required">*</span> <input id="author" name="author" type="text" class="form-control rounded-0" value="' . esc_attr( $commenter['comment_author'] ) . '" required="required" /> </div> <div class="col-6"><label class="mb-4" for="email">' . __( 'Email', 'domainreference' ) . '</label> <span class="required">*</span><br><input id="email" name="email" class="form-control rounded-0" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" required="required" /></div></div>',
      'comment_field' => '<div class="form-group position-relative text-primary fw-bold"><label class="mb-4" for="comment">' . _x( 'Ostavi komentar', 'noun' ) . '</label> <span class="required">*</span><textarea id="comment" class="form-control rounded-0" name="comment" rows="15" required="required" placeholder="Ovde unesi komentar..."></textarea></p>',
